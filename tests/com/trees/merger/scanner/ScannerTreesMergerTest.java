...
public class ScannerTreesMergerTest extends TestCase {
	...
	public void testWriteStringIntoFile() {
		String str = "A.B : 1\nA.B.C : 1\nA.B.D : 3\nA.C : 1\nA2/B/C : 4";
		ScannerTreesMerger scannerTreesMerger = new ScannerTreesMerger();
		scannerTreesMerger.writeStringIntoFile(RESULT_FILE_PATH, str);
		Scanner scanner = scannerTreesMerger.getScannerFromFile(RESULT_FILE_PATH);
	...
	public void testWriteStringIntoFile2() {
		ScannerTreesMerger scannerTreesMerger = new ScannerTreesMerger();
		String str = "A : 8\nA/B : 7\nA/B/C : 2\nA/B/D : 3\nA/C : 1\nA1 : 1\nA1/B1 : 1\nA1/B1/C : 1\nA2 : 4\nA2/B : 4\nA2/B/C : 4";
		scannerTreesMerger.writeStringIntoFile(RESULT_FILE_PATH, str);
		Scanner scanner = scannerTreesMerger.getScannerFromFile(RESULT_FILE_PATH);
	...
	public void testMapToString() {
		...
		ScannerTreesMerger scannerTreesMerger = new ScannerTreesMerger();
		String mapAsString = scannerTreesMerger.mapToString(map);
	...
	public void testParseFileIntoMapByScanner() {
		ScannerTreesMerger scannerTreesMerger = new ScannerTreesMerger();
		Map<String, Integer> map = new TreeMap<String, Integer>();
		String str = "A.B : 1\nA.B.C : 1\nA.B.D : 3\nA.C : 1\nA2/B/C : 4";
		scannerTreesMerger.writeStringIntoFile(FILE1_PATH, str);
		Scanner fileScanner = scannerTreesMerger.getScannerFromFile(FILE1_PATH);
		scannerTreesMerger.parseFileIntoMapByScanner(fileScanner, map);
	...
	public void testParseFileIntoMapByScanner2() {
		ScannerTreesMerger scannerTreesMerger = new ScannerTreesMerger();
		Map<String, Integer> map = new TreeMap<String, Integer>();
		String str = "A/B/C : 1\nA/B : 1\nA1/B1/C : 1";
		scannerTreesMerger.writeStringIntoFile(FILE1_PATH, str);
	...
	public void testMergeTwoTreesByScanner() {
		ScannerTreesMerger scannerTreesMerger = new ScannerTreesMerger();
		String str1 = "A/B/C : 1\nA/B : 1\nA1/B1/C : 1";
		scannerTreesMerger.writeStringIntoFile(FILE1_PATH, str1);
		String str2 = "A.C : 1\nA.B : 1\nA.B.D : 3\nA.B.C : 1\nA2/B/C : 4";
		scannerTreesMerger.writeStringIntoFile(FILE2_PATH, str2);
		scannerTreesMerger.mergeTwoTreesByScanner(FILE1_PATH, FILE2_PATH, RESULT_FILE_PATH);
		Scanner resultScanner = scannerTreesMerger.getScannerFromFile(RESULT_FILE_PATH);
